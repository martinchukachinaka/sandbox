...
/**
 * A DTO for the DbProcConfig entity.
 */
public class DbProcConfigDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DbProcConfigDTO dbProcConfigDTO = (DbProcConfigDTO) o;
        if (dbProcConfigDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), dbProcConfigDTO.getId());
    }
