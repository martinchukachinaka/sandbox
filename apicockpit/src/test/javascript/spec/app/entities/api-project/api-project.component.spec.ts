...
import { ApiProjectComponent } from 'app/entities/api-project/api-project.component';
...
describe('Component Tests', () => {
    describe('ApiProject Management Component', () => {
        let comp: ApiProjectComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ApiProjectComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.apiProjects[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
