...
public class GeneralInfoServiceImpl extends AbsractBankService implements GeneralInfoService {
	...
	public GeneralInterfaceVersion getInterfaceVersion() throws ServiceOperationNotSupported {
		return dataService.getSingleFromList(GENERAL_INFO_MODEL_FILE_NAME,GeneralInterfaceVersion.class);
	}
	...
	public BankMeta getBankMeta() throws ServiceOperationNotSupported {
		return dataService.getSingleFromList(BANK_META_MODEL_FILE_NAME,BankMeta.class);
	}
	...
	public List<GeneralCharges> getCharges() throws ServiceOperationNotSupported {
		return dataService.getModelList(CHARGES_MODEL_FILE_NAME,GeneralCharges.class);
	}
	...
	public List<GeneralGetProduct> getProducts() throws ServiceOperationNotSupported {
		return dataService.getModelList(PRODUCTS_MODEL_FILE_NAME,GeneralGetProduct.class);
	}
